...
const categorias = ref([
  { nome: 'Ferragens' },
  { nome: 'Hidráulicos' },
  { nome: 'Produtos Controlados' },
  { nome: 'Trefilados' },
  { nome: 'Pecuária' }
])
const marcas = ref([
  'Belgo', 'Cipla', 'Fortit', 'Fábrica de Pregos', 'Prata Brito', 'Triângulo'
])
const volumes = ref([
  '65 Litros'
])
const pesos = ref([
  '1 Kg', '100 Metros', 'Nº 16', 'Nº 18', 'Nº 20'
])
const opcoes = ref([
  '250 Metros', '500 Metros', '1/2"', '1000 Metros', '20Kg', 'Único'
])
