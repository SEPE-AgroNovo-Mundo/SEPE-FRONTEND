...
const marcas = ref([
  'Bayer', 'Diazitop', 'De Sangosse', 'Citromax', 'Imbatível', 'Envu', 'Royal'
])
const tipos = ref([
  'Insetos', 'Roedores', 'Baratas', 'Formiga', 'Bovinos', 'Outros'
])
const volumes = ref([
  '1 Litro', '100 Ml', '250 Ml', '30 Ml', '500 Ml', '100 g'
])
const pesos = ref([
  '10 g', '1 Kg', '25 g', '100 g', '500 g'
])
const opcoes = ref([
  'Único', 'Caixa Com 40', 'Unidade', '1 Kg Em 4 Pacotes De 250 G Cada', '20 Pacotes Com 12 Pastilhas Cada'
])
